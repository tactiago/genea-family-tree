...
const TreeNodeV2: React.FC<NodeProps> = ({ data }) => {
  const { person, onSelect, hasAncestors, ancestorsCollapsed, onToggleAncestors } =
    data as unknown as TreeNodeV2Data;
  ...
  return (
    <>
      ...
      >
        {hasAncestors && onToggleAncestors && (
          <div
            role="button"
            tabIndex={0}
            onClick={(e) => {
...
export default memo(TreeNodeV2);
